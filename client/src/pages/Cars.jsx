...
import {assets, dummyCarData} from '/Users/prateekkumar/Desktop/coding/car rental/client/src/assets/assets.js'
...
<p className='text-gray-500 xl:px-20 max-w-7x1 mx-auto'>Showing {dummyCarData.length} Cars</p>

<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-4
xl:px-20 max-w-7x1 mx-auto'>
