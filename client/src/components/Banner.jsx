  ...
  return (
    <div className='flex flex-col md:flex-row md:items-start items-center justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
      ...
      <div className='text-white'>
        ...
        <p className='max-w-md'>We take care of insurance, driver verification and secure payments - so you can earn passive income, stress-free.</p>
      ...
      <img src={assets.banner_car_image} alt="car" className='max-h-48 mt-10' />
    </div>
  )
}
