...
transition={{ duration: 0.8, delay: 0.2 }}
      className='text-4xl md:text-5xl font-semibold'>Luxuary Cars On Rent</motion.h1>
...
whileTap={{scale: 0.95 }}
className='flex items-center justify-center gap-1 px-8 py-3 max-sm:mt-4 bg-primary hover:bg-primary-dull text-white rounded-full cursor-pointer'> 
